...
Class FlowRasterMap
    ...
    ReadOnly fileFilterRegex As String = String.Format(CultureInfo.CurrentCulture, FILE_FILTER_ID_REGEX, SPATIAL_MAP_FLOW_TYPE_VARIABLE_PREFIX)
    ...
    Private Function CreateExportFilename(ByVal filename As String) As String
        ...
        If Not m.Success Or m.Groups.Count <> 4 Then
            ...
            Debug.Assert(False, "Error parsing the Spatial Flow internal filename.")
            Return filename
        End If
        ...
        Return String.Format(CultureInfo.InvariantCulture, "{0}{1}-{2}.{3}", m.Groups(1), SPATIAL_MAP_EXPORT_FLOW_TYPE_VARIABLE_PREFIX, name, m.Groups(3))
