...
Module Constants
    ...
    Public Const DATASHEET_STOCK_TRANSITION_MULTIPLIER_NAME As String = "SF_StockTransitionMultiplier"
    ...
    Public Const STOCK_VALUE_COLUMN_NAME As String = "StockValue"
