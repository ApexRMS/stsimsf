...
namespace SyncroSim.STSimStockFlow
{
    class StockTypeDataSheet : DataSheet
    {
        ...
        protected override void OnDataFeedsRefreshed()
        {
            ...
            this.m_StockGroupDataSheet = this.Project.GetDataSheet(Constants.DATASHEET_STOCK_GROUP_NAME );
        ...
        protected override void OnModifyingRows(object sender, DataSheetRowEventArgs e)
        {
            ...
            foreach (DataRow dr in this.m_StockTypeDataTable.Rows)
            {
                ...
                string TypeName = Convert.ToString(dr[Constants.NAME_COLUMN_NAME, DataRowVersion.Current], CultureInfo.InvariantCulture);
        ...
        private Dictionary<string, DataRow> CreateStockGroupRowDictionary()
        {
            ...
            foreach (DataRow dr in this.m_StockGroupDataTable.Rows)
            {
                if (dr.RowState != DataRowState.Deleted)
                {
                    d.Add(Convert.ToString(dr[Constants.NAME_COLUMN_NAME], CultureInfo.InvariantCulture), dr);
                }
            }
        ...
        {
            return GetAutoGeneratedGroupName(Convert.ToString(dr[Constants.NAME_COLUMN_NAME], CultureInfo.InvariantCulture));
        }
