...
namespace SyncroSim.STSimStockFlow
{
	internal partial class StockFlowTransformer
	{
		...
		private void NormalizeOutputOptions()
		{
			...
			this.ValidateTimesteps(droo, Constants.DATASHEET_OO_AVG_SPATIAL_OUTPUT_LFL_COLUMN_NAME, Constants.DATASHEET_OO_AVG_SPATIAL_OUTPUT_LFL_TIMESTEPS_COLUMN_NAME, "Average lateral flows", MaxTimestep);
        }
