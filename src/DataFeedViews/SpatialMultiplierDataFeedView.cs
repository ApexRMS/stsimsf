...
namespace SyncroSim.STSimStockFlow
{
	...
	internal partial class SpatialMultiplierDataFeedView
	{
		...
		public override void LoadDataFeed(SyncroSim.Core.DataFeed dataFeed)
		{
			...
			this.m_MultipliersView.LoadDataFeed(dataFeed, Constants.DATASHEET_FLOW_SPATIAL_MULTIPLIER_NAME);
		...
		private void GetMultiplierFile(int rowIndex)
		{
			...
			DataSheet ds = this.Scenario.GetDataSheet(Constants.DATASHEET_FLOW_SPATIAL_MULTIPLIER_NAME);
			string RasterFile = RasterUtilities.ChooseRasterFileName("Flow Spatial Mulitplier Raster File");
