...
Class SpatialMultiplierDataFeedView
    ...
    Const FILE_NAME_COLUMN_INDEX As Integer = 3
    Const BROWSE_COLUMN_INDEX As Integer = 4
    ...
    Public Overrides Sub LoadDataFeed(dataFeed As SyncroSim.Core.DataFeed)
        ...
        Me.m_MultipliersView.LoadDataFeed(dataFeed, DATASHEET_FLOW_SPATIAL_MULTIPLIER_NAME)
    ...
    Private Sub GetMultiplierFile(ByVal rowIndex As Integer)
        ...
        Dim ds As DataSheet = Me.Scenario.GetDataSheet(DATASHEET_FLOW_SPATIAL_MULTIPLIER_NAME)
        Dim RasterFile As String = ChooseRasterFileName("Flow Spatial Mulitplier Raster File")
