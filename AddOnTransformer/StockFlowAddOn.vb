...
'Class StockFlowAddOn
'    Inherits StochasticTimeTransformer

'    Const DENSITY_GROUP_NAME As String = "stockflow_density_group"

'    Protected Overrides Sub ModifyLayout(ByVal layout As SyncroSimLayout)

'        If (layout.Name = "syncrosim-core:result-transformers") Then
...
'        Else
'            MyBase.ModifyLayout(layout)
'        End If

'    End Sub

'    Public Overrides Sub RefreshChartCriteria(ByVal layout As SyncroSimLayout, ByVal project As Project)
